              ...
              child: Row(
                ...
                children: [
                  ...
                  const Text('القرآن الكريم',
                    style: TextStyle(fontFamily: 'AmiriQuran', fontSize: 26, fontWeight: FontWeight.w700, color: _gold, height: 1.5)),
                  _HeaderIconBtn(icon: Icons.search_rounded, onTap: () => context.push('/quran/search')),
                ],
              ),
            ),
...
class _OrnamentDivider extends StatelessWidget {
  ...
  Widget _dot(double s, double o) => Container(width: s, height: s,
    decoration: BoxDecoration(shape: BoxShape.circle, color: _gold.withOpacity(o)));
}
      ...
      child: Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            filled: true, fillColor: _parchment,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: TabBar(
        ...
        labelColor: _green, unselectedLabelColor: _inkLight,
        indicatorColor: _gold, indicatorSize: TabBarIndicatorSize.label,
        indicatorWeight: 2.5, dividerColor: Colors.transparent,
    ...
    return surahsAsync.when(
      ...
      data: (surahs) {
        ...
        return ListView.separated(
          ...
          itemBuilder: (_, i) => _SurahRow(surah: filtered[i], onTap: () => context.push('/quran/surah/${filtered[i].number}')),
        );
      },
    );
  }
...
class _SurahRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: onTap, splashColor: _gold.withOpacity(0.08), highlightColor: _gold.withOpacity(0.04),
      child: Padding(
...
class _NumberBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Center(child: Text(ArabicUtils.toArabicNumerals(number),
        style: const TextStyle(fontFamily: 'AmiriQuran', fontSize: 13, color: _gold, fontWeight: FontWeight.w700))),
    );
  }
}
